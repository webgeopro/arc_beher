...
<html xmlns="https://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="/themes/backend/filemanager/css/style.css" rel="stylesheet" type="text/css" />
		<link href="/themes/backend/filemanager/js/jPlayer/skin/blue.monday/jplayer.blue.monday.css" rel="stylesheet" type="text/css">
	<!--[if lt IE 8]><style>
	...
	<script src="/themes/backend/filemanager/js/plugins.js"></script>
	<script src="/themes/backend/filemanager/js/jPlayer/jquery.jplayer/jquery.jplayer.js"></script>
	<script src="/themes/backend/filemanager/js/modernizr.custom.js"></script>
	<?php
	if ($aviary_active){
	...
	<script src="/themes/backend/filemanager/js/include.js"></script>
</head>
<body>
		...
		foreach ($files as $file_array) {
		  $file=$file_array['file'];
			    ...
			    <?php } ?>
				  <a class="folder-link" href="dialog.php?<?php echo $get_params.rawurlencode($src)."&".uniqid() ?>">
					  <div class="img-precontainer">
							...
							<img class="directory-img"  src="/themes/backend/filemanager/img/<?php echo $icon_theme; ?>/folder<?php if($file==".."){ echo "_back"; }?>.png" />
							</div>
					  </div>
			...
			$file=$file_array['file'];
			    ...
			    if($src_thumb==""){
				$no_thumb=true;
				if(file_exists('/themes/backend/filemanager/img/'.$icon_theme.'/'.$extension_lower.".jpg")){
					$src_thumb ='/themes/backend/filemanager/img/'.$icon_theme.'/'.$extension_lower.".jpg";
				}else{
					$src_thumb = "/themes/backend/filemanager/img/".$icon_theme."/default.jpg";
				}
				$is_icon_thumb=true;
			    }
			    if($mini_src==""){
...
<script>
    ...
    <div id="loading_container" style="display:none;">
	    ...
	    <img id="loading_animation" src="/themes/backend/filemanager/img/storing_animation.gif" alt="loading" style="z-index:10001; margin-left:-32px; margin-top:-32px; position:fixed; left:50%; top:50%"/>
    </div>
    <!-- loading div end -->
